 ...
 * Exercise 4-11.
 *
 * Modify getop so that it does not need ungetch. The function keeps one
 * lookahead character in an internal static variable.
 *
 * This version preserves the functionality added in previous calculator
 * exercises:
 *
 *     %, negative numbers
 *     ?, d, s, c
