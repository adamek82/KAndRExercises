...
TESTS += $(CHAPTER01_TESTS)
PHONY_TARGETS += $(CHAPTER01_TESTS) experiment-ch01-ex02
...
test-ch01-ex19: debug
	@$(RM_RF) build/debug/chapter01/exercise19.out build/debug/chapter01/exercise19.expected

	@printf 'abc\nhello\nx\n' | ./build/debug/chapter01/exercise19$(EXEEXT) | tr -d '\r' > build/debug/chapter01/exercise19.out
	@printf 'cba\nolleh\nx\n' > build/debug/chapter01/exercise19.expected
	@$(CMP) -s build/debug/chapter01/exercise19.out build/debug/chapter01/exercise19.expected

	@printf '\n' | ./build/debug/chapter01/exercise19$(EXEEXT) | tr -d '\r' > build/debug/chapter01/exercise19.out
	@printf '\n' > build/debug/chapter01/exercise19.expected
	@$(CMP) -s build/debug/chapter01/exercise19.out build/debug/chapter01/exercise19.expected

	@printf '%s' 'abc' | ./build/debug/chapter01/exercise19$(EXEEXT) | tr -d '\r' > build/debug/chapter01/exercise19.out
	@printf '%s' 'cba' > build/debug/chapter01/exercise19.expected
	@$(CMP) -s build/debug/chapter01/exercise19.out build/debug/chapter01/exercise19.expected
	...
	@$(RM_RF) build/debug/chapter01/exercise19.out build/debug/chapter01/exercise19.expected
	@echo "chapter01/exercise19 tests passed"

test-ch01-ex20: debug
	@$(RM_RF) build/debug/chapter01/exercise20.out build/debug/chapter01/exercise20.expected

	@printf 'a\tb\n' | ./build/debug/chapter01/exercise20$(EXEEXT) | tr -d '\r' > build/debug/chapter01/exercise20.out
	@printf 'a       b\n' > build/debug/chapter01/exercise20.expected
	@$(CMP) -s build/debug/chapter01/exercise20.out build/debug/chapter01/exercise20.expected
...
test-ch01-ex22: debug
	@$(RM_RF) build/debug/chapter01/exercise22.out build/debug/chapter01/exercise22.expected

	@printf 'short\n' | ./build/debug/chapter01/exercise22$(EXEEXT) | tr -d '\r' > build/debug/chapter01/exercise22.out
	@printf 'short\n' > build/debug/chapter01/exercise22.expected
	@$(CMP) -s build/debug/chapter01/exercise22.out build/debug/chapter01/exercise22.expected
	...
	@printf '%s' 'one two three four five' | ./build/debug/chapter01/exercise22$(EXEEXT) | tr -d '\r' > build/debug/chapter01/exercise22.out
	@printf 'one two three four\nfive' > build/debug/chapter01/exercise22.expected
	@$(CMP) -s build/debug/chapter01/exercise22.out build/debug/chapter01/exercise22.expected

	@$(RM_RF) build/debug/chapter01/exercise22.out build/debug/chapter01/exercise22.expected
	@echo "chapter01/exercise22 tests passed"

test-ch01-ex23: debug
	@$(RM_RF) build/debug/chapter01/exercise23.out build/debug/chapter01/exercise23.expected

	@printf '%s\n' 'int/**/x;' | ./build/debug/chapter01/exercise23$(EXEEXT) | tr -d '\r' > build/debug/chapter01/exercise23.out
	...
	@printf "%s\n" "char c = '/';/* remove */" | ./build/debug/chapter01/exercise23$(EXEEXT) | tr -d '\r' > build/debug/chapter01/exercise23.out
	@printf "%s\n" "char c = '/'; " > build/debug/chapter01/exercise23.expected
	@$(CMP) -s build/debug/chapter01/exercise23.out build/debug/chapter01/exercise23.expected

	@printf '%s\n' 'int x; // remove this' 'int y;' | ./build/debug/chapter01/exercise23$(EXEEXT) | tr -d '\r' > build/debug/chapter01/exercise23.out
	@printf '%s\n' 'int x; ' 'int y;' > build/debug/chapter01/exercise23.expected
	@$(CMP) -s build/debug/chapter01/exercise23.out build/debug/chapter01/exercise23.expected

	@printf 'int x;/* one\ntwo */int y;\n' | ./build/debug/chapter01/exercise23$(EXEEXT) | tr -d '\r' > build/debug/chapter01/exercise23.out
	@printf '%s\n' 'int x; int y;' > build/debug/chapter01/exercise23.expected
	@$(CMP) -s build/debug/chapter01/exercise23.out build/debug/chapter01/exercise23.expected
